"""
Python_file/script to demonstrate getting and working with user input
"""
...
# read in two numbers from the user and perform some basic arithmetic operations on them
print(f"Please enter the first number/value to be used in the calculation:")
first_number = int(input())
second_number = int(input(f"Please enter the second number/value to be used in the calculation:\n"))
...
print(f"Calculation results".center(50))
print("*"*50)
